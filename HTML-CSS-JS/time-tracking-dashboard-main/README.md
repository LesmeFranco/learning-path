...
- Solution URL: [Add solution URL here](https://github.com/LesmeFranco/learning-path/tree/main/HTML-CSS-JS/time-tracking-dashboard-main)
- Live Site URL: [Add live site URL here](https://time-tracking-dashboard-gold-three.vercel.app/)
